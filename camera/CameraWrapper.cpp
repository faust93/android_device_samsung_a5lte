...
const static char * preview_size_values = "1920x1080,1440x1080,1280x720,1056x864,960x720,880x720,800x480,640x480,528x432,352x288,320x240";
...
static char *camera_fixup_getparams(int id, const char *settings)
{
    ...
    // fix params here
    params.set(android::CameraParameters::KEY_SUPPORTED_PREVIEW_SIZES, preview_size_values);
